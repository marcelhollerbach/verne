...
history_init(void)
{
   elm_layout_signal_callback_add(layout, "kvasir.history.back", "theme", _back_cb, NULL);
   elm_layout_signal_callback_add(layout, "kvasir.history.forward", "theme", _forward_cb, NULL);
