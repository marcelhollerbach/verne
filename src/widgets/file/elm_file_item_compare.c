...
_elm_file_item_compare_efl_compare_compare(Eo *obj EINA_UNUSED, Elm_File_Item_Compare_Data *pd, const void *data)
{
   ...
   pd2 = eo_data_scope_get(data, ELM_FILE_ITEM_COMPARE_CLASS);
...
EOLIAN static void
_elm_file_item_compare_file_set(Eo *obj EINA_UNUSED, Elm_File_Item_Compare_Data *pd, Efm_File *file)
{
    pd-> file = file;
...
_elm_file_item_compare_file_get(Eo *obj EINA_UNUSED, Elm_File_Item_Compare_Data *pd)
{
    return pd->file;
}


#include "elm_file_item_compare.eo.x"